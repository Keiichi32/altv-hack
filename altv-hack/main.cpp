...
DWORD WINAPI Main()
{
    ...
    LPVOID Connect = Utils::FindPattern("altv-client.dll", "\x48\x8b\xc4\x48\x89\x58\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8d\xa8\x00\x00\x00\x00\x48\x81\xec\x00\x00\x00\x00\x0f\x29\x70\x00\x0f\x29\x78\x00\x48\x8b\x05\x00\x00\x00\x00\x48\x33\xc4\x48\x89\x85\x00\x00\x00\x00\x4c\x8b\xe2", "xxxxxx?xxxxxxxxxxxxxx????xxx????xxx?xxx?xxx????xxxxxx????xxx");

    Hacks::Initialize(LoadResource, OpenFile, NewString, SocialId, MachineGuid, ProductId, LicenseHash, Connect);
